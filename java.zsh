...
alias j16='remove_java_path;export JAVA_HOME=/Library/Java/JavaVirtualMachines/adoptopenjdk-16.jdk/Contents/Home;export PATH=${JAVA_HOME}/bin:${PATH};java -version'
